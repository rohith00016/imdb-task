...
import { fetchActorById, updateActor } from "../../redux/actions/actorActions";
...
const UpdateActor = () => {
  ...
  useEffect(() => {
    dispatch(fetchActorById(id, navigate));
  }, [dispatch, id]);
  ...
  useEffect(() => {
    if (actor) {
      setFormData({
        ...
        dob: actor.dob || "",
        bio: actor.bio || "",
        profilePic: actor.profilePic || null,
      });
    }
  }, [actor]);
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      dispatch(updateActor(id, actorData, navigate));
    }
  };

  return (
    <div className="container mx-auto p-4 max-w-md">
      <h2 className="text-2xl font-bold mb-2">Update Actor</h2>
